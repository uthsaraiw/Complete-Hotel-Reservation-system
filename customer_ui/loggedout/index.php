    ...
    <div class="body">
            ...
            <?php 
              ...
              if ($result2->num_rows > 0) {
                  ...
                  while ($row = $result2->fetch_assoc()) {
                    ...
                    echo '<p style="font-weight: 2px; text-indent: 35px;color:blue;"> validity:' . $start_date .' to '. $exp_date .'</p>';
                    echo '<a href="bookings_hotels.php?hotel_id='.$hotel_id.'"> <p class="mySlides1-button"> Find a stay</p> </a>';
                    echo '</div>';
        ...
        <div>
          ...
          <div class="slideshow-container2">
            ...
            <div class="mySlides2 fade mySlides2-float">
              <a href="bookings_elements.php?search=nuwara_eliya"><img class="img-slide2" src="http://localhost/co226/project/customer_ui/images/offers/img1.jpg"></a>
              <p>Nuwara Eliya</p>
            </div>

            <div class="mySlides2 fade mySlides2-float">
              <a href="bookings_elements.php?search=kandy"><img class="img-slide2" src="http://localhost/co226/project/customer_ui/images/offers/img2.jpg" ></a>
              <p>Kandy</p>
            </div>

            <div class="mySlides2 fade mySlides2-float">
              <a href="bookings_elements.php?search=colombo"><img class="img-slide2" src="http://localhost/co226/project/customer_ui/images/offers/img3.jpg" ></a>
              <p>Colombo</p>
            </div>

            <div class="mySlides2 fade mySlides2-float">
              <a href="bookings_elements.php?search=anuradhapura"><img class="img-slide2" src="http://localhost/co226/project/customer_ui/images/offers/img1.jpg" ></a>
              <p>Anuradhapura</p>
            </div>

            <div class="mySlides2 fade mySlides2-float">
              <a href="bookings_elements.php?search=jaffna"><img class="img-slide2" src="http://localhost/co226/project/customer_ui/images/offers/img2.jpg" ></a>
              <p>Jaffna</p>
            </div>

            <div class="mySlides2 fade mySlides2-float">
              <a href="bookings_elements.php?search=trincomalee"><img class="img-slide2" src="http://localhost/co226/project/customer_ui/images/offers/img3.jpg" ></a>
              <p>Trincomalee</p>
            </div>

            <div class="mySlides2 fade mySlides2-float">
              <a href="bookings_elements.php?search=galle"><img class="img-slide2" src="http://localhost/co226/project/customer_ui/images/offers/img1.jpg" ></a>
              <p>Galle</p>
            </div>

            <div class="mySlides2 fade mySlides2-float">
              <a href="bookings_elements.php?search=mathale"><img class="img-slide2" src="http://localhost/co226/project/customer_ui/images/offers/img2.jpg" ></a>
              <p>Mathale</p>
            </div>

            <div class="mySlides2 fade mySlides2-float">
              <a href="bookings_elements.php?search=mannar"><img class="img-slide2" src="http://localhost/co226/project/customer_ui/images/offers/img3.jpg">
</a>              <p>Mannar</p>
            </div>
      ...
      <div class="trending margin clear">
        ...
        <div class="row1">
          ...
          <a href="bookings_elements.php?search=<?php echo ucwords($popular_cities[0]);?>"><img class="trending-row1-img" src="http://localhost/co226/project/customer_ui/images/trending/<?php echo ucwords($popular_cities[0]);?>.jpg" ></a>
          ...
          <a href="bookings_elements.php?search=<?php echo ucwords($popular_cities[1]);?>"><img class="trending-row1-img" src="http://localhost/co226/project/customer_ui/images/trending/<?php echo ucwords($popular_cities[1]);?>.jpg" ></a>
        ...
        <div class="row2">
          ...
          <a href="bookings_elements.php?search=<?php echo ucwords($popular_cities[2]);?>"><img class="trending-row2-img" src="http://localhost/co226/project/customer_ui/images/trending/<?php echo ucwords($popular_cities[2]);?>.jpg" ></a>
          ...
          <a href="bookings_elements.php?search=<?php echo ucwords($popular_cities[3]);?>"><img class="trending-row2-img" src="http://localhost/co226/project/customer_ui/images/trending/<?php echo ucwords($popular_cities[3]);?>.jpg" ></a>
          ...
          <a href="bookings_elements.php?search=<?php echo ucwords($popular_cities[4]);?>"><img class="trending-row2-img" src="http://localhost/co226/project/customer_ui/images/trending/<?php echo ucwords($popular_cities[4]);?>.jpg" ></a>
