...
<body>
    <nav>
      <a class="active" href="http://localhost/co226/project/customer_ui/loggedin/indexloggedin.php?guest_id=<?php echo $guestid ?>">
        ...
        <div class="login-signup-customer">
          <a href="http://localhost/co226/project/customer_ui/loggedout/index.html?guest_id=<?php echo $guestid ?>">
            <p>Logout</p>
          </a>
        </div>
    </nav>
    ...
    <div class="body">
      ...
      <div class="reserve-area-buttons">
        <a href="customer_reservation.php?guest_id=<?php echo $guestid ?>&hotel_id=<?php echo $hotel_id ?>">
          <p>Reserve</p>
        </a>
        <div class="tooltip">
